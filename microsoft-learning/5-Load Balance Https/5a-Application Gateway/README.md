...
> From Microsoft Learning [Lab](https://github.com/MicrosoftLearning/AZ-700-Designing-and-Implementing-Microsoft-Azure-Networking-Solutions/blob/master/Instructions/Exercises/M05-Unit%204%20Deploy%20Azure%20application%20gateway.md)
> 
> and [Microsoft Learn Path](https://learn.microsoft.com/en-us/training/modules/load-balancing-https-traffic-azure/4-exercise-deploy-azure-application-gateway)
...
2. On any Azure Portal page, in **Search resources, services and docs (G+/)**, enter application gateway, and then select **Application gateways** from the results.
    ![Azure Portal search for application gateway](https://github.com/MicrosoftLearning/AZ-700-Designing-and-Implementing-Microsoft-Azure-Networking-Solutions/raw/master/Instructions/media/search-application-gateway.png)    
...
19. Accept the default values for the other settings on the **Listener** tab.
    ...
    ![Azure Portal add an Application Gateway routing rule](https://github.com/MicrosoftLearning/AZ-700-Designing-and-Implementing-Microsoft-Azure-Networking-Solutions/raw/master/Instructions/media/Routing-rule-listener-tab.png)
...
7. Under **Target**, select **BackendVM2.** 
   ...
   ![Azure Portal add target backends to backend pool](https://github.com/MicrosoftLearning/AZ-700-Designing-and-Implementing-Microsoft-Azure-Networking-Solutions/raw/master/Instructions/media/edit-backend-pool.png)
...
1. Find the public IP address for the application gateway on its **Overview** page. 
   ...
   ![Azure Portal look up Frontend Public IP address ](https://github.com/MicrosoftLearning/AZ-700-Designing-and-Implementing-Microsoft-Azure-Networking-Solutions/raw/master/Instructions/media/app-gw-public-ip.png)
...
3. Check the response. A valid response verifies that the application gateway was successfully created and can successfully connect with the backend.
   ...
   ![Broswer - display BackendVM1 or BackendVM2 depending which backend server reponds to request.](https://github.com/MicrosoftLearning/AZ-700-Designing-and-Implementing-Microsoft-Azure-Networking-Solutions/raw/master/Instructions/media/browse-to-backend.png)
